  	...
  	return (
  		<div className={ classes.root }>
            ...
            <div className={ classes.intro }>
            	<Typography variant='h3' id="manage.Text.1" >{i18next.t('manage.Text.1')}</Typography>
            </div>
  				}
  				{ !account.address &&
            <div className={ classes.introCenter }>
            	<Typography variant='h3' id="manage.Text.2" >{i18next.t('manage.Text.2')}</Typography>
            </div>
  				}
  				<div className={ classes.balancesContainer }>
  					{ false && <div className={ classes.overlay } onClick={ this.overlayClicked }>
  						<Typography variant='h1'  id="manage.Text.3" >{i18next.t('manage.Text.3')}</Typography>
  					</div>}
  				</div>
            ...
            <div className={ classes.connectContainer }>
            	...
            	>
            		<Typography className={ classes.buttonText } variant={ 'h5'} id="manage.Text.4" >{i18next.t('manage.Text.4')}</Typography>
            	</Button>
            </div>
  				}
