//i18n => {"redeemModal.Text.1":"Cancel","redeemModal.Text.2":"Submit"}
  			...
  			<DialogContent>
  				...
  				<div className={ classes.actionsContainer }>
  					<Button
  						...
  						onClick={ closeModal }
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} id="redeemModal.Text.1" >{i18next.t('redeemModal.Text.1')}</Typography>
  					</Button>
  					<Button
  						className={ classes.actionButton }
  						variant="contained"
  					...
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} color='secondary' id="redeemModal.Text.2" >{i18next.t('redeemModal.Text.2')}</Typography>
  					</Button>
  				</div>
  			</DialogContent>
  		</Dialog>
