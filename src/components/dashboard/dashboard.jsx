  		...
  		return (
  			<div className={ classes.root }>
  				<div className={ classes.investedContainerLoggedOut }>
  					<Typography variant={'h5'} className={ classes.disaclaimer } id="dashboard.Text.1" >{i18next.t('dashboard.Text.1')}</Typography>
  					<div className={ classes.introCenter }>
  						<Typography variant='h3' id="dashboard.Text.2" >{i18next.t('dashboard.Text.2')}</Typography>
  					</div>
  				</div>
  			</div>
  		);
  		...
  		<div className={ classes.root }>
  			<div className={ classes.investedContainer}>
                ...
                <div className={ classes.inline }>
                	...
                	<Typography className={ classes.symbol } variant={ 'h3' } id="dashboard.Text.3" >{i18next.t('dashboard.Text.3')}</Typography>
                </div>
  						}
  						<Typography variant={ 'h4' } className={ classes.gray } id="dashboard.Text.4" >{i18next.t('dashboard.Text.4')}</Typography>
  					</div>
