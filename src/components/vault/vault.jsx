  		...
  		return (
  			<div className={ classes.root }>
  				<div className={ classes.investedContainerLoggedOut }>
  					<Typography variant={'h5'} className={ classes.disaclaimer } id="vault.Text.1" >{i18next.t('vault.Text.1')}</Typography>
  					<div className={ classes.introCenter }>
  						<Typography variant='h3' id="vault.Text.2" >{i18next.t('vault.Text.2')}</Typography>
  					</div>
  				</div>
  	...
  	return (
  		<div className={ classes.root }>
  			<div className={ classes.investedContainer }>
  				<Typography variant={'h5'} className={ classes.disaclaimer } id="vault.Text.3" >{i18next.t('vault.Text.3')}</Typography>
  				{ this.renderFilters() }
  				{ this.renderBasedOn() }
