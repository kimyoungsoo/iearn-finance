  	...
  	return (
  		<div className={ classes.root }>
  			<Card className={ classes.inputCard }>
  				<Typography variant='h3' className={ classes.inputCardHeading } id="invested.Text.1" >{i18next.t('invested.Text.1')}</Typography>
  				<div className={ classes.inputCardValues }>
  					...
  					<Typography variant='h5' className={ classes.inputCardSubtitle } align='right' id="invested.Text.2" >{i18next.t('invested.Text.2')}</Typography>
  				</div>
  			</Card>
  			<Card className={ classes.assetsCard }>
  				<Typography variant='h3' className={ classes.assetCardHeading } id="invested.Text.3" >{i18next.t('invested.Text.3')}</Typography>
  		...
  		<div className={ classes.tableRoot }>
  			<div className={ classes.tableHeaderRow }>
  				<div className={ `${classes.tableHeaderCell} ${classes.tableHeaderCell1}` }>
  					<Typography variant='body2' className={ classes.tableHeaderCellText } id="invested.Text.4" >{i18next.t('invested.Text.4')}</Typography>
  				</div>
  				<div className={ classes.tableHeaderCell }>
  					<Typography variant='body2' className={ classes.tableHeaderCellText } align='right' id="invested.Text.5" >{i18next.t('invested.Text.5')}</Typography>
  				</div>
  				<div className={ `${classes.tableHeaderCell} ${classes.tableHeaderCellLast}` }>
  					<Typography variant='body2' className={ classes.tableHeaderCellText } align='right' id="invested.Text.6" >{i18next.t('invested.Text.6')}</Typography>
  				</div>
  			</div>
  			{ assets.map((asset) => {
