  		...
  		<div className={ classes.root }>
  			<div className={ classes.headerV2 }>
  				<div className={ classes.icon }>
  					<img
  						...
  						onClick={ () => { this.nav(''); } }
  					/>
  					<Typography variant={ 'h3'} className={ classes.name } onClick={ () => { this.nav(''); } } id="header.Text.1" >{i18next.t('header.Text.1')}</Typography>
  				</div>
              ...
              <Typography variant={ 'h4'} className={ classes.walletAddress } noWrap onClick={this.addressClicked} >
              	...
              	<div className={ classes.connectedDot }></div>
  					...
  					{ !address &&
              <Typography variant={ 'h4'} className={ classes.walletAddress } noWrap onClick={this.addressClicked}  id="header.Text.2" >{i18next.t('header.Text.2')}</Typography>
  					}
  				</div>
  			</div>
