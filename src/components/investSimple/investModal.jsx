  			...
  			<DialogContent>
  				...
  				<div className={ classes.actionsContainer }>
  					<Button
  						...
  						onClick={ closeModal }
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} id="investModal.Text.1" >{i18next.t('investModal.Text.1')}</Typography>
  					</Button>
  					<Button
  						className={ classes.actionButton }
  						variant="contained"
  					...
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} color='secondary' id="investModal.Text.2" >{i18next.t('investModal.Text.2')}</Typography>
  					</Button>
  				</div>
  			</DialogContent>
  			{ loading && <Loader /> }
