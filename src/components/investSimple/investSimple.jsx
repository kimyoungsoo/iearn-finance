  		...
  		return (
  			<div className={ classes.root }>
  				<div className={ classes.investedContainerLoggedOut }>
  					<Typography variant={'h5'} className={ classes.disaclaimer } id="investSimple.Text.1" >{i18next.t('investSimple.Text.1')}</Typography>
  					<div className={ classes.introCenter }>
  						<Typography variant='h3' id="investSimple.Text.2" >{i18next.t('investSimple.Text.2')}</Typography>
  					</div>
  				</div>
  	...
  	return (
  		<div className={ classes.root }>
  			<div className={ classes.investedContainer }>
  				<Typography variant={'h5'} className={ classes.disaclaimer } id="investSimple.Text.3" >{i18next.t('investSimple.Text.3')}</Typography>
  				<div className={ classes.intro }>
  					<ToggleButtonGroup value={value} onChange={this.handleTabChange} aria-label="version" exclusive size={ 'small' }>
  						<ToggleButton value={0} aria-label="v1">
  							<Typography variant={ 'h4' } id="investSimple.Text.4" >{i18next.t('investSimple.Text.4')}</Typography>
  						</ToggleButton>
  						<ToggleButton value={1} aria-label="v2">
  							<Typography variant={ 'h4' } id="investSimple.Text.5" >{i18next.t('investSimple.Text.5')}</Typography>
  						</ToggleButton>
  						<ToggleButton value={2} aria-label="v3">
  							<Typography variant={ 'h4' } id="investSimple.Text.6" >{i18next.t('investSimple.Text.6')}</Typography>
  						</ToggleButton>
  					</ToggleButtonGroup>
  				</div>
