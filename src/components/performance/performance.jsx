  		...
  		<div className={ classes.root }>
  			<div className={ classes.investedContainer }>
  				<div className={ classes.intro }>
  					<Typography variant='h3' id="performance.Text.1" >{i18next.t('performance.Text.1')}</Typography>
  				</div>
  	...
  	return (
  		<div key={ 'name' } className={ classes.pair }>
  			<div className={ classes.headerName }>
  				<Typography align='left' variant={'h3'} id="performance.Text.2" >{i18next.t('performance.Text.2')}</Typography>
  			</div>
  			<div className={ classes.headerApr }>
  				<Typography variant={'h3'} align='right' id="performance.Text.3" >{i18next.t('performance.Text.3')}</Typography>
  			</div>
  			<div className={ classes.headerApr }>
  				<Typography variant={'h3'} align='right' id="performance.Text.4" >{i18next.t('performance.Text.4')}</Typography>
  			</div>
  			<div className={ classes.headerApr }>
  				<Typography variant={'h3'} align='right' id="performance.Text.5" >{i18next.t('performance.Text.5')}</Typography>
  			</div>
  			<div className={ classes.headerApr }>
