  		...
  		return (
  			<div className={ classes.root }>
  				<div className={ classes.investedContainerLoggedOut }>
  					<Typography variant={'h5'} className={ classes.disaclaimer } id="zap.Text.1" >{i18next.t('zap.Text.1')}</Typography>
  					<div className={ classes.introCenter }>
  						<Typography variant='h3' id="zap.Text.2" >{i18next.t('zap.Text.2')}</Typography>
  					</div>
  				</div>
  	...
  	return (
  		<div className={ classes.root }>
  			<div className={ classes.card }>
  				<Typography variant={'h5'} className={ classes.disaclaimer } id="zap.Text.3" >{i18next.t('zap.Text.3')}</Typography>
